...
def register_rainbow_web(app, line_bot_api):
    ...
    async def api_me(request: Request):
        uid, gid = _auth(request)
        return JSONResponse(_player_data(line_bot_api, gid, uid), headers={'Cache-Control': 'no-store'})
