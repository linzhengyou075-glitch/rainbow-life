...
.frame-avatar-shell.frame-leader_glory .avatar-frame-art{inset:-58px;width:calc(100% + 116px);height:calc(100% + 116px);filter:drop-shadow(0 0 12px #ffd86a) drop-shadow(0 0 25px rgba(255,87,208,.74));animation:frameOwnerGlow 2.8s ease-in-out infinite}
...
@media(max-width:680px){.avatar-wrap .avatar-frame-art{width:154px;height:154px}.avatar-wrap.frame-diamond_crown .avatar-frame-art{width:164px;height:164px}.avatar-wrap.frame-leader_glory .avatar-frame-art{width:176px;height:176px}}

/* Owner 彩虹星空頭像框最終版：不改版面，只升級框與最外圈特效 */
.avatar-wrap.frame-leader_glory .avatar-frame-art{width:232px;height:232px;filter:drop-shadow(0 0 9px rgba(255,78,202,.78)) drop-shadow(0 0 15px rgba(84,210,255,.54));animation:ownerRainbowFrameBreath 3.6s ease-in-out infinite}
.avatar-wrap.frame-leader_glory .avatar{width:164px;height:164px;box-shadow:0 0 0 4px rgba(15,8,48,.92),0 0 17px rgba(97,214,255,.36)}
.avatar-wrap.frame-leader_glory:after{display:block;width:228px;height:228px;background:conic-gradient(from 0deg,rgba(255,69,69,.0),rgba(255,133,35,.82),rgba(255,232,71,.22),rgba(65,236,131,.78),rgba(55,202,255,.2),rgba(92,102,255,.82),rgba(223,75,255,.24),rgba(255,69,165,.82),rgba(255,69,69,.0));filter:blur(5px);opacity:.78;animation:ownerRainbowOuterSpin 8s linear infinite;mask:radial-gradient(circle,transparent 61%,#000 64%,#000 70%,transparent 73%);-webkit-mask:radial-gradient(circle,transparent 61%,#000 64%,#000 70%,transparent 73%)}
.owner-frame-host.owner-active:before,.s331-avatar-frame:before,.frame-avatar-shell.frame-leader_glory:before{content:"";position:absolute;inset:-5%;border-radius:50%;z-index:0;pointer-events:none;background:conic-gradient(from 20deg,transparent,rgba(255,134,35,.9),transparent 15%,rgba(68,236,146,.85),transparent 31%,rgba(54,202,255,.9),transparent 48%,rgba(116,91,255,.9),transparent 65%,rgba(240,74,255,.88),transparent 81%,rgba(255,76,126,.9),transparent);filter:blur(4px);opacity:.72;animation:ownerRainbowOuterSpin 7s linear infinite}
.owner-frame-host.owner-active>.owner-frame-overlay{inset:-8%;width:116%;height:116%;filter:drop-shadow(0 0 7px rgba(255,82,202,.76)) drop-shadow(0 0 12px rgba(72,213,255,.48));animation:ownerRainbowFrameBreath 3.6s ease-in-out infinite}
.s331-avatar-art{filter:drop-shadow(0 0 7px rgba(255,80,203,.72)) drop-shadow(0 0 10px rgba(74,209,255,.45));animation:ownerRainbowFrameBreath 3.6s ease-in-out infinite}
@keyframes ownerRainbowOuterSpin{to{transform:rotate(360deg)}}
@keyframes ownerRainbowFrameBreath{0%,100%{transform:scale(.985);filter:brightness(1) saturate(1.08) drop-shadow(0 0 7px rgba(255,82,202,.7))}50%{transform:scale(1.025);filter:brightness(1.22) saturate(1.32) drop-shadow(0 0 15px rgba(82,214,255,.9))}}
...
(function(){
 ...
 let filter='all';
 function source(f){if(f.owner_only)return '群長專屬';if(f.vip_only)return 'VIP 有效期間';if(f.achievement_name)return f.achievement_name;return f.frame_key==='rainbow_basic'?'預設頭像框':'成就／活動取得'}
