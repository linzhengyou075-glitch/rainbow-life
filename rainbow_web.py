...
/* Step 3.2 overrides */
function openAdminWeb(section){try{if(section)sessionStorage.setItem('rainbow_admin_section',section);else sessionStorage.removeItem('rainbow_admin_section')}catch(e){}location.href='/player/admin'+location.search}
